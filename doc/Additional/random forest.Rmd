...
accu_sd <- res_cv_total$`mean error`[6]
tpr.fpr <- WeightedROC(as.numeric(pred_rf), test_label)
auc <- WeightedAUC(tpr.fpr)
auc_sd<-res_cv_total$`sd error`[6]


cat("Accuracy:",accu*100, "%.\n")
cat("SD of accuracy:",accu_sd, "\n")
cat("AUC:", auc, ".\n")
cat("SD of AUC:", auc_sd, ".\n")
```
Accuracy: 79 %.
SD of accuracy: 0.0575 
AUC: 0.5543608 .
SD of AUC: 0.01118034
...
```
Time for constructing training features= 1.74 s 
Time for constructing testing features= 0.17 s 
Time for training model= 122.32 s 
